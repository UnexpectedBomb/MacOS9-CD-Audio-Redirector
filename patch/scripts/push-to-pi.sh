#!/bin/bash
# Stage CDPatch2a on the Pi's share (/home/csell/shared/) so the OS 9 machine can
...
BASES="CDPatch2a CDPatchInstall"
...
echo "push-to-pi: CDPatch2a in ${SHARE}/ on pi3.local"
